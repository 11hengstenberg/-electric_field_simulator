...
def repulcion(particula,velocidad_inicial,angulo_inicial,largo_suelo,campo_electrico):
    if (campo_electrico<0):
        campo_electrico = campo_electrico*-1
        particula[0]= particula[0]*-1
    ...
    #tiempo total
    tiempo_total =  (2*velocidad_Y)/(aceleracion)
    ...
    while (velocidad_X*tiempo_inicial) <= largo_suelo:
...
#repulcion(particula,velocidad_inicial,angulo_inicial,largo_suelo,campo_electrico)